...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size_train", type=int, default=124)
    ...
    if args.train:
        #class_weights=[1.0/dataset["train"]["targets"].count(0), 1.0/dataset["train"]["targets"].count(1), 1.0/dataset["train"]["targets"].count(2), 1.0/dataset["train"]["targets"].count(3)]
        class_weights=[1.0, 1.0, 1.0, 1.0]
        train(word2vec=word2vec, dataset=dataset, parameters=parameters, class_weights=class_weights)
